...
/**
 * Based on https://github.com/prettier/prettier/blob/main/src/common/ast-path.js
 * @implements {AstPath}
 */
class LezerPath {
  /** @type {LezerNode} */ #node;

  constructor(/** @type {LezerNode} */ node) {
    this.#node = node;
  }
...
module.exports.LezerPath = LezerPath;

/**
 * Based on https://github.com/prettier/prettier/blob/main/src/common/ast-path.js
 * @implements {AstPath}
 */
class LezerAstPath extends LezerPath {
  /** @type {LezerNode} */ #parent;
  /** @type {number} */ #index;

  constructor(/** @type {LezerNode} */ parent, /** @type {number} */ index) {
    super(parent.children[index]);
    this.#parent = parent;
    this.#index = index;
  }
...
module.exports.LezerAstPath = LezerAstPath;
