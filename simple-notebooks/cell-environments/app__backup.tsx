...
// 	- [ ] **Dependencies**
// 	Yes, yes, a Pluto style inline widget is cool, but I think I could do with a dedicated tab right now.

// ╔═╡ [cells.28918307-ec74-4909-8b06-4d0eb6b82718]
// ╠═╡ type = "text"
// ## Local running
// I want the editor to have a local version. Easier to show off, easier to work on the editor only _(as long as I don't end up in an infinite loop, that is)_. Could make the dependencies work with `JSPM` and for typechecking I could make a `JSPM`-like CDN to serve bundled types for a package.
